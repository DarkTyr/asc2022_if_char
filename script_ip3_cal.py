...
while (idx < nSteps):
    ...
    synth0.setPowerdBm(np.round(power_list_dBm[idx] + SYNTH0_POWER_OFFSET, 2))
    synth1.setPowerdBm(np.round(power_list_dBm[idx] + SYNTH1_POWER_OFFSET, 2))
...
np.savez_compressed("ipx_data/Power_List_2022-10-13_1704", 
                    nSteps = nSteps,
                    ...
                    SYNTH0_POWER_OFFSET = SYNTH0_POWER_OFFSET,
                    SYNTH1_POWER_OFFSET = SYNTH1_POWER_OFFSET
                    )
