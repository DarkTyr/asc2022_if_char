...
np.savez_compressed("s_data/SN013L_S55_rf_bbterm_4p5GHz", freqs = freqs, data=data_s11)
np.savez_compressed("s_data/SN013L_S66_rf_bbterm_4p5GHz", freqs = freqs, data=data_s22)
